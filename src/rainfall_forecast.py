...
@click.command()
@click.option("--settings_file", type = str, required = True, default = './src/settings-mwi.yml', show_default = True, help = "YAML file with global settings (input/output file names, etc.)" )
